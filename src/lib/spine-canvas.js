            ...
            if (alpha == 1) {
                ...
                if (vertexAttachment.bones == null) {
                    ...
                    for (var i_6 = 0; i_6 < vertexCount; i_6++) {
                        ...
                        vertices[i_6] =
                            (prev + (nextVertices[i_6] - prev) * percent) *
                            alpha;
                    }
                }
            } else {
...
(function (spine) {
    ...
    var BinaryInput = (function () {
        function BinaryInput(t) {
            this.offset = 0;
            this.size = 0;
            this.buffer = null;
            this.floatBuf = null;
            this.floatBufIn = null;
            this.floatBufOut = null;
            this.doubleBuf = null;
            this.doubleBufIn = null;
            this.doubleBufOut = null;
            (this.offset = 0),
        ...
        BinaryInput.prototype.readBool = function () {
        ...
        BinaryInput.prototype.readInt = function () {
            var t = this.readByte();
            return (
                (t <<= 8),
                (t |= this.readByte()),
        ...
        BinaryInput.prototype.readVarInt = function (t) {
            void 0 === t && (t = !0);
            var e = this.readByte(),
                r = 127 & e;
            return (
    ...
    var SkeletonBinary = (function () {
        function SkeletonBinary(t) {
            this.scale = 1;
            this.linkedMeshes = new Array();
            this.attachmentLoader = t;
        }
        SkeletonBinary.prototype.readSkeletonData = function (r) {
            var n = this.scale;
            var a = new BinaryInput(r);
            ...
            for (var s = 0, h = a.readVarInt(); s < h; s++) {
                ...
                var d = new spine.BoneData(s, l, u);
            ...
            for (var s = 0, p = a.readVarInt(); s < p; s++) {
                ...
                var d = new spine.SlotData(s, f, M),
                    g = a.readColor();
                null != g && d.color.set(g[0], g[1], g[2], g[3]);
                var m = a.readColor();
                null != m &&
                    ((d.darkColor = new spine.Color(1, 1, 1, 1)),
            ...
            for (var s = 0, y = a.readVarInt(); s < y; s++) {
                var d = new spine.IkConstraintData(a.readString());
            ...
            for (var s = 0, T = a.readVarInt(); s < T; s++) {
                var d = new spine.TransformConstraintData(a.readString());
                d.order = a.readVarInt();
                for (var x = 0, h = a.readVarInt(); x < h; x++) {
                    var v = a.readVarInt(),
                        w = i.bones[v];
            ...
            for (var s = 0, E = a.readVarInt(); s < E; s++) {
                var d = new spine.PathConstraintData(a.readString());
                d.order = a.readVarInt();
                for (var x = 0, h = a.readVarInt(); x < h; x++) {
                    var v = a.readVarInt(),
                        w = i.bones[v];
                ...
                (d.positionMode = a.readByte()),
                    ...
                    d.positionMode == spine.PositionMode.Fixed &&
                        (d.position *= n),
                    (d.spacing = a.readFloat()),
                    (d.spacingMode != spine.SpacingMode.Length &&
                        d.spacingMode != spine.SpacingMode.Fixed) ||
                        (d.spacing *= n),
                    (d.rotateMix = a.readFloat()),
                    (d.translateMix = a.readFloat()),
                    i.pathConstraints.push(d);
            }
            var b = new spine.Skin('default');
            for (var s = 0, p = a.readVarInt(); s < p; s++)
                for (
                    var C = a.readVarInt(), x = 0, R = a.readVarInt();
                    x < R;
                    x++
                ) {
                    var I = a.readString(),
            ...
            for (var s = 0, P = a.readVarInt(); s < P; s++) {
                var V = new spine.Skin(a.readString());
                for (var x = 0, p = a.readVarInt(); x < p; x++)
                    for (
                        var C = a.readVarInt(), F = 0, R = a.readVarInt();
                        F < R;
                        F++
                    ) {
                        var I = a.readString(),
            ...
            for (var s = 0, N = a.readVarInt(); s < N; s++) {
                var d = new spine.EventData(a.readString());
        ...
        SkeletonBinary.prototype.readAttachment = function (e, r, i, a, o, s) {
            var h = this.scale,
                l = e.readString();
            l || (l = a);
            var u = e.readByte();
            switch (u) {
                ...
                case spine.AttachmentType.BoundingBox: {
                    var f = this.attachmentLoader.newBoundingBoxAttachment(
                        r,
                        l
                    );
                ...
                case spine.AttachmentType.Mesh: {
                    ...
                    var g = [];
                    for (var m = 0, y = e.readVarInt(); m < y; m++)
                        g.push(e.readFloat()), g.push(e.readFloat());
                    var x = [];
                    for (var m = 0, w = e.readVarInt(); m < w; m++)
                        x.push(e.readShort());
                    if (
                        ((M.triangles = x),
                        (M.regionUVs = g),
                        ...
                        for (var A = [], m = 0, T = e.readVarInt(); m < T; m++)
                            A.push(e.readShort());
                ...
                case spine.AttachmentType.Path: {
                    ...
                    var R = spine.Utils.newArray(v / 3, 0);
                    for (var m = 0; m < R.length; m++) R[m] = e.readFloat() * h;
                    if (((c.lengths = R), s)) {
                        var p = e.readColor();
        ...
        SkeletonBinary.prototype.readVertices = function (e, r, n) {
            var i = this.scale;
            ...
            (r.bones = c), (r.vertices = spine.Utils.toFloatArray(u));
        };
        SkeletonBinary.prototype.readAnimation = function (e, r, n) {
            var i = this.scale;
            var a = new Array();
            var o = 0;
            var s = 0;
            ...
            for (; s < h; s++)
                for (
                    var l = e.readVarInt(), u = 0, c = e.readVarInt();
                    u < c;
                    u++
                ) {
                    var d = e.readByte() + 4,
                        p = e.readVarInt();
                    if (d == spine.TimelineType.attachment) {
                        var f = new spine.AttachmentTimeline(p);
                        f.slotIndex = l;
                        for (var v = 0, M = 0; M < p; M++)
                            f.setFrame(v++, e.readFloat(), e.readString());
                        a.push(f),
                            (o = Math.max(o, f.frames[f.getFrameCount() - 1]));
                    } else if (d == spine.TimelineType.color) {
                        var f = new spine.ColorTimeline(p);
                        f.slotIndex = l;
                        ...
                        if (d != spine.TimelineType.deform)
                            throw new Error(
                        ...
                        var f = new spine.TwoColorTimeline(p);
                        f.slotIndex = l;
            ...
            for (var s_1 = 0, T = e.readVarInt(); s_1 < T; s_1++)
                for (
                    var E = e.readVarInt(), u = 0, c = e.readVarInt();
                    u < c;
                    u++
                ) {
                    var d = e.readByte(),
                        p = e.readVarInt();
                    if (d === spine.TimelineType.rotate) {
                        var f = new spine.RotateTimeline(p);
                        f.boneIndex = E;
                        for (var v = 0, b = 0; b < p; b++)
                        ...
                        if (
                            d !== spine.TimelineType.translate &&
                            d !== spine.TimelineType.scale &&
                            d !== spine.TimelineType.shear
                        )
                            throw new Error(
                        ...
                        var f = null,
                            C = 1;
                        d === spine.TimelineType.scale
                            ? (f = new spine.ScaleTimeline(p))
                            : d === spine.TimelineType.shear
                            ? (f = new spine.ShearTimeline(p))
                            : ((f = new spine.TranslateTimeline(p)), (C = i)),
                            (f.boneIndex = E);
            ...
            for (var s_2 = 0, P = e.readVarInt(); s_2 < P; s_2++) {
                var V = e.readVarInt(),
                    p = e.readVarInt(),
                    f = new spine.IkConstraintTimeline(p);
            ...
            for (var s_3 = 0, P = e.readVarInt(); s_3 < P; s_3++) {
                var L = e.readVarInt(),
                    p = e.readVarInt(),
                    f = new spine.TransformConstraintTimeline(p);
            ...
            for (var s_4 = 0, P = e.readVarInt(); s_4 < P; s_4++)
                for (
                    var k = e.readVarInt(),
                    ...
                    var d = e.readByte() + 11,
                        p = e.readVarInt();
                    if (
                        d === spine.TimelineType.pathConstraintPosition ||
                        d === spine.TimelineType.pathConstraintSpacing
                    ) {
                        var f = null,
                            C = 1;
                        d === spine.TimelineType.pathConstraintSpacing
                            ? ((f = new spine.PathConstraintSpacingTimeline(p)),
                              (N.spacingMode != spine.SpacingMode.Length &&
                                  N.spacingMode != spine.SpacingMode.Fixed) ||
                                  (C = i))
                            : ((f = new spine.PathConstraintPositionTimeline(
                                  p
                              )),
                              N.positionMode == spine.PositionMode.Fixed &&
                                  (C = i)),
                    ...
                    } else if (d === spine.TimelineType.pathConstraintMix) {
                        var f = new spine.PathConstraintMixTimeline(p);
                        f.pathConstraintIndex = k;
                        for (var v = 0, U = 0; U < p; U++)
                            f.setFrame(
                                v,
                                e.readFloat(),
                                e.readFloat(),
            ...
            for (var s_5 = 0, P = e.readVarInt(); s_5 < P; s_5++) {
                var O = e.readVarInt(),
                    X = n.skins[O];
                if (null == X) throw new Error('Skin not found: ' + O);
                for (var u = 0, D = e.readVarInt(); u < D; u++)
                    for (
                        var l = e.readVarInt(), Y = 0, W = e.readVarInt();
                        Y < W;
                        Y++
                    ) {
                        var G = e.readString(),
                        ...
                        if (null == q)
                            throw new Error(
                                'Deform attachment not found: ' + G
                            );
                        var z = null != q.bones,
                            j = q.vertices,
                            H = z ? (j.length / 3) * 2 : j.length,
                            p = e.readVarInt(),
                            f = new spine.DeformTimeline(p);
                        ...
                        for (var v = 0, Q = 0; Q < p; Q++) {
                            var m = e.readFloat(),
                                ...
                                K = void 0;
                            if (0 == Z)
                                K = z ? spine.Utils.newFloatArray(H) : j;
                            else {
                                K = spine.Utils.newFloatArray(H);
                                var J = e.readVarInt();
                                if (((Z += J), 1 == i))
                                    for (var $ = J; $ < Z; $++)
                                        K[$] = e.readFloat();
            ...
            var et = e.readVarInt();
            if (et > 0) {
                var f = new spine.DrawOrderTimeline(et);
                var h_1 = n.slots.length;
                for (var s_6 = 0; s_6 < et; s_6++) {
                    var m = e.readFloat();
                    var rt = e.readVarInt();
                    var nt = spine.Utils.newArray(h_1, -1);
                    var it = new Array(h_1 - rt);
                    var at = 0;
                    var ot = 0;
                    var u = 0;
                    for (; u < rt; u++) {
                    ...
                    for (; at < h_1; ) it[ot++] = at++;
                    for (var u_1 = h_1 - 1; u_1 >= 0; u_1--)
                        nt[u_1] == -1 && (nt[u_1] = it[--ot]);
                    f.setFrame(s_6, m, nt);
                }
            ...
            var st = e.readVarInt();
            if (st > 0) {
                var f = new spine.EventTimeline(st);
                for (var s_7 = 0; s_7 < st; s_7++) {
                    var m = e.readFloat(),
                        ht = e.readVarInt(),
                        lt = n.events[ht];
                    if (null == lt) throw new Error('Event not found: ' + ht);
                    var ut = new spine.Event(
                        spine.Utils.toSinglePrecision(m),
                        lt
                    );
            ...
            n.animations.push(new spine.Animation(r, a, o));
        };
        SkeletonBinary.prototype.readCurve = function (e, r, n) {
            var i = e.readByte();
            i === spine.CurveTimeline.STEPPED
                ? r.setStepped(n)
                : i === spine.CurveTimeline.BEZIER &&
                  r.setCurve(
                      n,
                      e.readFloat(),
                      e.readFloat(),
