...
declare namespace spine {
    class AssetManager implements Disposable {
        ...
        loadBinary(
            path: string,
            success?: (path: string, data: Uint8Array) => void,
...
declare namespace spine {
    ...
    export class SkeletonBinary {
        ...
        readSkeletonData(r: Uint8Array): SkeletonData;
        readAttachment(
            e: BinaryInput,
            r: Skin,
            i: number,
        ...
        readAnimation(e: BinaryInput, r: string, n: SkeletonData): void;
        readCurve(e: BinaryInput, r: CurveTimeline, n: number): void;
    }
    export {};
}
declare namespace spine {
...
declare namespace spine {
    ...
    class FakeTexture extends spine.Texture {
        setFilters(
            minFilter: spine.TextureFilter,
            magFilter: spine.TextureFilter
        ): void;
